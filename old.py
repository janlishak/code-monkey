...
#             znak += 1
#             if mapa[x][y] == '1':
#                 canvas.create_rectangle(x * bunka, y * bunka, (x + 1) * bunka, (y + 1) * bunka, fill='orange', width=0,
#                                         tags='obejkty_mapy')
#
...
#     global mapGoal
#     canvas.delete('texty')
#     canvas.create_text(width // 8, height + scorebar_haight // 2, text='Length: ' + str(len(had)), font='Arial 16 bold',
#                        tags='texty', fill='purple')
#     canvas.create_text(width // 8 * 7, height + scorebar_haight // 2, text='Next level: ' + str(mapGoal),
#                        font='Arial 16 bold', tags='texty', fill='purple')
#     canvas.create_text(width // 2, height + scorebar_haight // 2, text='Level: ' + str(level), font='Arial 16 bold',
#                        tags='texty', fill='purple')
#
#
# def pohyb_hada():
...
#     canvas.delete('had')
#     for cast in had:
#         canvas.create_rectangle(cast[0] * bunka, cast[1] * bunka, cast[0] * bunka + bunka, cast[1] * bunka + bunka,
#                                 fill=colors[cast[3]], tags='had', width=1)
#
#
# def novy_bod():
...
#             if len(had) < mapGoal:
#                 mapa[x][y] = '7'
#                 canvas.create_rectangle(x * bunka, y * bunka, x * bunka + bunka, y * bunka + bunka, fill='white',
#                                         tags='bod', width=0)
#             else:
#                 mapa[x][y] = '9'
#                 canvas.create_rectangle(x * bunka, y * bunka, x * bunka + bunka, y * bunka + bunka, fill='black',
#                                         tags='bod', width=0)
#
#             hladaj = False
#
